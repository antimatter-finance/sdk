...
export declare class Trade {
     ...
     */
    static exactIn(chainId: ChainId, route: Route, amountIn: CurrencyAmount): Trade;
    /**
     ...
     */
    static exactOut(chainId: ChainId, route: Route, amountOut: CurrencyAmount): Trade;
    constructor(chainId: ChainId, route: Route, amount: CurrencyAmount, tradeType: TradeType);
    /**
